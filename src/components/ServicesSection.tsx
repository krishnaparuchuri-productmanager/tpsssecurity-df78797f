import { ShieldCheck, Building2, Landmark, UserCheck, Camera, MapPin } from "lucide-react";
...
const services = [
  ...
  { icon: Landmark, title: "Government & PSU Security", desc: "PSARA-compliant services for public sector assets" },
  ...
  { icon: MapPin, title: "Event & Highway Security", desc: "Armed guards for events, tolls, and highway deployments" },
];
