import { ShieldCheck, Star, Radio, RefreshCw } from "lucide-react";

const points = [
  { icon: ShieldCheck, label: "PSARA-Compliant Operations" },
  { icon: Star, label: "Led by Retired Defense & Police Officers" },
  { icon: Radio, label: "24/7 Control Room with Wireless Communication" },
  { icon: RefreshCw, label: "Immediate Guard Replacement Guaranteed" },
];
