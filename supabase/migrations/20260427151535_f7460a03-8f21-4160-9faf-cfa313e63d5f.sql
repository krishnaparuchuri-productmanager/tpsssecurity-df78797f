...
-- Tighten notifications insert: must target self OR be ceo_admin/coo_ops creating system notification
...
-- Tighten audit_logs insert: user_id must be auth.uid() (or null for system actions by admins)
